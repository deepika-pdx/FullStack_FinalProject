      ...
      <div className="activitiesBlockClass">
        ...
        >
          <Tooltip title="Solve Jigsaw Puzzles">
            <img
              src={jigsawPuzzleIcon}
              alt="Jigsaw puzzles icon"
              width="170"
              height="130"
              className="individualActClass"
            ></img>
        ...
        <a
          href="https://www.movewithcolour.com/freeclasses"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://www.youtube.com/c/KunalKapur/videos"
          target="_blank"
          rel="noopener noreferrer"
        >
